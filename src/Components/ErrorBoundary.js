...
const ErrorFallback = ({ error, resetErrorBoundary, title, message, showRetry = true }) => (
  <ErrorContainer>
    <ErrorTitle>
...
export const RowErrorBoundary = ({ children }) => (
  <CustomErrorBoundary
...
export const MovieModalErrorBoundary = ({ children }) => (
  <CustomErrorBoundary
...
export const ImageErrorBoundary = ({ children }) => (
  <CustomErrorBoundary
