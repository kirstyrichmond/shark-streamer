...
interface Movie {
  ...
  [key: string]: any; // Adjust this to match the actual movie properties
}

const MovieCard = ({ movie, onClick, isSelected }: { movie: Movie; onClick?: (movie: Movie) => void; isSelected: boolean }) => {
