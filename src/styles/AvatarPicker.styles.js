...
export const CategoryTab = styled.button`
  ...
  border: 2px solid ${(props) => props.$active ? '#e50914' : '#666'};
  padding: 8px 16px;
  border-radius: 4px;
  cursor: pointer;
  font-size: 1rem;
  ...
  &:hover {
    border-color: ${(props) => props.$active ? '#e50914' : '#999'};
...
export const AvatarOption = styled.div`
  ...
  border-radius: 8px;
  overflow: hidden;
  border: 3px solid ${(props) => props.$selected ? '#e50914' : 'transparent'};
  transition: all 0.3s ease;

  &:hover {
    border-color: ${(props) => props.$selected ? '#e50914' : '#fff'};
